...
BOT_TOKEN = getenv("BOT_TOKEN", "7227942593:AAEjEu4NKFlWrlnjHBsNtskNaQmvWQLmZRg")
...
LOG_GROUP = getenv("LOG_GROUP", "-1002202175238")
CHANNEL_ID = int(getenv("CHANNEL_ID", "2182291545"))
